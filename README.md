...
- Without `NYRRA_GH_TOKEN`, the workflow skips `nyrra-foundry-cli-bin` and `nyrra-signals-bin` and still updates public packages such as `scryu-bin` and `windsurf`.
